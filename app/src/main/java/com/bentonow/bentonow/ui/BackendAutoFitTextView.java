...
public class BackendAutoFitTextView extends TextView implements AutofitHelper.OnTextSizeChangeListener {
    ...
    public BackendAutoFitTextView(Context context) {
        super(context);
        init(context, null, 0);
    }

    public BackendAutoFitTextView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs, 0);
    }

    public BackendAutoFitTextView(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void init(Context context, AttributeSet attrs, int defStyle) {
        ...
        TypedArray a = context.getTheme().obtainStyledAttributes(attrs, R.styleable.BackendTextView, 0, 0);
