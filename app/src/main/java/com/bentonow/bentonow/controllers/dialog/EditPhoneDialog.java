...
public class EditPhoneDialog extends Dialog implements View.OnClickListener {
    ...
    public EditPhoneDialog(Context context, String message, boolean progressbar) {
        super(context);
    ...
    public EditPhoneDialog(Context context, boolean input) {
        super(context);
        requestWindowFeature(Window.FEATURE_NO_TITLE);
    ...
    public EditPhoneDialog(Context context, String message, String acceptButton, String cancelButton) {
        super(context);
        requestWindowFeature(Window.FEATURE_NO_TITLE);
        setContentView(R.layout.dialog_custom);
        setMessage(message);
